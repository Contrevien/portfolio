...
const BOX_Y = {
    ...
    'lg': [20, 72, 87, 7, 52, 12, 29, 64, 21, 3, 33, 53, 55, 75, 12, 55, 12, 72, 91, 43, 35],
    'md': [20, 75, 25, 3, 35, 12, 29, 64, 21, 3, 33, 53, 55, 20, 12, 42, 25, 60, 3, 10, 5, 12],
    'sm': [20, 19, 25, 3, 35, 6, 25, 64, 21, 50, 33, 53, 37, 20, 12, 42, 12],
}
...
const Boxes = () => {
    ...
    return (
        appear && boxes.map((b) => <Box {...b} key={`${b.x}${b.y}`} />)
    )
}
